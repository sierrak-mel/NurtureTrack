...
- **Feeding Tracker** — Log breastfeeding sessions with side and duration, or bottle feeds with amount
- **Diaper Tracker** — Record wet, dirty, or mixed diaper changes
- **Sleep Tracker** — Track naps and nighttime sleep with start/end times
- **Pumping Tracker** — Log pumping sessions with duration and output
- **Daily Summary** — View a timeline of your baby's day at a glance
- **Dark Mode** — Easy on the eyes for late-night feeds
- **Multi-Caregiver Support** — Share access with your partner or other caregivers

## Getting Started

### Creating an Account

1. Visit the app at your hosted URL
2. Tap **Sign Up** and enter your email and a password
3. Check your email for a confirmation link and verify your account
4. Once confirmed, log in and set up your baby's profile
...
3. Under **Caregivers**, invite your partner or another caregiver by entering their email
